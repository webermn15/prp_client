...
import { ModalOverlay, ModalContent, ContentHeader, Button, HeaderText, SubHeaderText, SubSubHeaderText, WarningIcon } from '../../../../style';
		...
		return(
			<ModalOverlay>
				<ModalContent>
					...
					(<div>
						<div>
							<ContentHeader url={defaultSsbmHeader}>
								<div>
